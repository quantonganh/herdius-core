...
func (m *MockBackuperI) BackupNeededBaseBlocks(arg0 *protobuf.BaseBlock) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BackupNeededBaseBlocks", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (mr *MockBackuperIMockRecorder) BackupNeededBaseBlocks(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BackupNeededBaseBlocks", reflect.TypeOf((*MockBackuperI)(nil).BackupNeededBaseBlocks), arg0)
}
